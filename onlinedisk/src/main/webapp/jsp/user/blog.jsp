	...
	<div class="container-fluid">
		<div class="row">
			...
			<div id="managerurl"
				...
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right">
						<li><a href="writeblog.jsp">新的博客</a></li>
					</ul>
				</div>
				<div class="table-responsive">
					<table class="table table-striped">
						...
						<tbody>
							<c:forEach items="${bloglist}" var="bloginfo"  varStatus="status">
								<tr>
									<td>${status.index}</td>
									<td><a href="readblog.jsp?item=${status.index}">${bloginfo.blogname}</a></td>
									<td>${bloginfo.modifydate}</td>
									<td><a href="modifyblog.jsp?item=${status.index}">修改</a> &nbsp&nbsp&nbsp&nbsp<a href="blog/delete.do?item=${status.index}">删除</a></td>
									<!-- 自定义标签 -->
								</tr>
							</c:forEach>
						</tbody>
