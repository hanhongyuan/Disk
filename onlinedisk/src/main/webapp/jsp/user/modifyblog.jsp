...
<%request.setCharacterEncoding("UTF-8"); %>  
    <%List<Bloginfo> list = (List<Bloginfo>)session.getAttribute("bloglist");
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div id="managerurl"
				...
				<form action="blog/update.do" name="myform" method="post">
					<div class="input-group input-group-lg">
						<span class="input-group-addon">标题</span> <input type="text"
							name="name" class="form-control" placeholder="Twitterhandle" value="<%=blog.getBlogname() %>">
					</div>
					<textarea class="ckeditor" cols="80" id="content" name="content"
						rows="10"><%=blog.getBlogrtf() %></textarea>
				</form>
			</div>
		</div>
	</div>
